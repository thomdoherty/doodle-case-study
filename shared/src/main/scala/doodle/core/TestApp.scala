...
object TestApp extends App {
  ...
  val image2 = Circle (50 ) fillColor Color.white
  val image3 = Circle (10) fillColor Color.blue
  val image4 = image1 beside image2 below image3
  val bb = BoundingBox(image4)
  //canvas.setSize(500, 500)
  //canvas.setOrigin(-250, 200)
  canvas.setSize((bb.leftCoordinate - bb.rightCoordinate).toInt, 
